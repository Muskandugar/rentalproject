...
let data=[
    {
        "image2": "https://www.E-Rentals.com/bangalore/electronics/rent-oneplus-7-pro/91631",
        "image": "https://p.rmjo.in/productSquare/mxzy0xf9-500x500.jpg",
        "title": "OnePlus 7 Pro (Mirror Gray)",
        "price": "1669",
        "days": "3 days",
        "delivery": "https://www.E-Rentals.com/public/images/fast-delivery/fast-delivery.svg",
        "id": 4
      },      {
        "id": 3000018,
  ...
  const btnpressnext=()=>{
    ...
    return(
        <Box className={styled.carousel} py="60px" >
            <Text width={"130px"} textAlign={"left"} color="black" ml="2%">It'll make your Home complete!! </Text>
