    ...
    <Box
      ...
      fontSize="12px">
        <Box textAlign="left" maxW="81%" pt={"50px"}  display={{base:"none",md:"block"}} margin="auto">
            <Text fontWeight={600}> <b>Embrace Your Dream Lifestyle With E-rentals In Jaipur</b></Text>
            <Text objectFit={"cover"}>E-rentals is one of India’s best-known rental brands with a pan-India presence. You can rent furniture, appliances, and electronics from us in Jaipur for a monthly fee. Instead of paying tens of thousands to purchase said items from a store, you can rent them from us at a discounted price.</Text>
            <br />
            <Text>E-rentals provides very reasonable rental rates, allowing you to save a great deal of money. We offer convenient rental options, short-term and long-term. Our long-term plans offer maximum savings. No matter what plan you sign up for, you receive added benefits from us such as free relocation, damage waiver, and free maintenance.</Text>
            <br />
      ...
      <Container as={Stack} maxW={'6xl'} py={10} m="auto">
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
          <Stack align={'flex-start'}>
            <ListHeader>E-RENTALS</ListHeader>
            <Text>About Us</Text>
            <Text>Culture</Text>
            <Text>Contact</Text>
          ...
          <Stack align={'flex-start'}>
            ...
            <Text ml="20px"><TagLeftIcon as={BiPaperPlane}></TagLeftIcon> lok@E-Rentals.com</Text>
