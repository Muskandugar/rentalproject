        ...
        <Box display={"flex"} w={"90%"} margin="auto">
            ...
            <AccordionItem>
                ...
                <Stack >
                    ...
                    <Radio size="sm" value='tablets'><Text textAlign={"left"} fontSize="11px">TV</Text></Radio>
                    <Radio size="sm" value='tablets'><Text textAlign={"left"} fontSize="11px">CCTV camera</Text></Radio>
                </Stack>
                </RadioGroup>
                </AccordionPanel>
            </AccordionItem>
